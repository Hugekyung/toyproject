...
# https://itunes.apple.com/kr/rss/topgrossingapplications/genre={장르 코드}/limit={전체 개수}/json


class Top_Grossing_Category_Spider(scrapy.Spider):
    ...
    def start_requests(self):
        for key, value in self.category_code_dic.items():
            category = key
            category_code = value
            start_url = 'https://itunes.apple.com/kr/rss/topgrossingapplications/genre={}/limit=200/json'.format(category_code)
